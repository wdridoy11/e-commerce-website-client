            ...
            <div className='grid md:grid-cols-2 lg:grid-cols-4 gap-10'>
                <div>
                    ...
                    <div className='flex gap-2 mt-5'>
                        <Link className='text-xl border border-slate-400 p-2 text-black' to={`https://www.facebook.com/wdridoy11`}>
                            <FaFacebookF />
                        </Link>
                        <Link className='text-xl border border-slate-400 p-2 text-black' to={`https://www.instagram.com/wdridoy11`}>
                            <FaInstagram />
                        </Link>
                        <Link className='text-xl border border-slate-400 p-2 text-black' to={`https://twitter.com/wdridoy11`}>
                            <FaTwitter />
                        </Link>
                        <Link className='text-xl border border-slate-400 p-2 text-black' to={`https://www.linkedin.com/in/wdridoy11`}>
                            <FaLinkedin />
                        </Link>
                    </div>
                </div>
